...
module.exports = {
  ...
  onStart: async function ({ api, event, args, message }) {
    ...
    const loadingMessage = await message.reply("Piw Piw Chat Bot Loading your video...");
    ...
    try {
      ...
      if (!links || links.length === 0) {
        throw new Error("Piw Piw Chat Bot No corn video found for the provided query.");
      }
