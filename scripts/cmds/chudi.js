...
// ===== ADMIN ONLY =====
const botAdmins = global.botAdmin || ["1000XXXXXXXX"]; // admin UID বসা
if (!botAdmins.includes(event.senderID)) {
return api.sendMessage(
"❌ শুধু Bot Admin এই কমান্ড চালাতে পারবে",
event.threadID,
event.messageID
);
}
...
targetName = await Users.getName(targetID);
...
return api.sendMessage(
"⚠️ কারো মেসেজে reply দাও বা @mention কর",
event.threadID,
event.messageID
);
}
